...
{
    public class EfUserOperationClaimWriteRepository(DbContext context) : EfEntityWriteRepository<UserOperationClaim>(context), IUserOperationClaimWriteRepository
    {
    }
}
