...
{
    public class EfUserOperationClaimWriteRepository(IdentityDbContext context) : EfEntityWriteRepository<UserOperationClaim>(context), IUserOperationClaimWriteRepository
    {
    }
}
